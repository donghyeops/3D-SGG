...
class AttNet(nn.Module):
    def __init__(self,
                 nlabel=25, ncolor=10, nopen_state=3, nembedding=20, dropout=None,
        ...
        print('# visual_feature:', self.use_img)
        ...
        combine_feature_size = 0  # total feature size
    ...
    def forward(self, im_data, im_info, objects, gt_colors=None, gt_open_states=None):
        ...
        # im_data : (1, 3, 600, 600)
        if self.use_img:
            # roi_pool_object 입력 데이터 폼: (obj#, 5[0, xmin, ymin, xmax, ymax]), type=cuda_tensor
    ...
    def visualize(self, im_data, im_info, objects, gt_colors, gt_open_states):
        ...
        color_prob, open_state_prob = self(im_data, im_info, objects)
    ...
    def build_loss_att(self, color_score, open_state_score, gt_colors, gt_open_states):
        if self.class_weight_color is not None:
            ...
            color_weights = self.class_weight_color.cuda()
