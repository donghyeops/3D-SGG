...
class RelNet(ARNet_base):
    def __init__(self, predicate_loss_weight, dropout=False, nembedding=300, nlabel=25, nrelation=9):
        super(RelNet, self).__init__(predicate_loss_weight)
        self.predicate_loss_weight = predicate_loss_weight

        self.dropout = dropout

        self.coordinate_fc1 = FC(6*2, 512)
        self.coordinate_fc2 = FC(512, 512)
